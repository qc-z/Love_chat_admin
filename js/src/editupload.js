...
uploader.bind('FileUploaded', function(up, file, info) {
        ...
        if (info.status == 200)
        {
            ...
            if(temp == "pub"){
                //公开照片
                if(imgObject.pub.length < 6 ){
                    imgObject.pub.push(imgUrl)
                    $("#con .del").last().attr("data-name",imgUrl) 

                }
            }else if(temp == "common"){
            //私密照片
                if(imgObject.common.length < 6 ){
                    imgObject.common.push(imgUrl)
                    $("#con1 .del").last().attr("data-name",imgUrl) 
                }
            }else if(temp == "tour"){
            //旅游照片
                imgObject.tour = imgUrl;
            }else if(temp == "car"){
            //座驾照片
                imgObject.car = imgUrl;
            }else if(temp == "life"){
            //生活照片
                imgObject.life = imgUrl;
            }else if(temp == "house"){
            //豪宅照片
                imgObject.house = imgUrl

            }else if(temp == "goods"){
            //奢物照片
                imgObject.goods = imgUrl

            }else if(temp == "looks"){
            //素颜照片
                imgObject.looks = imgUrl

            }else if(temp == "sport"){
            //运动照片
                imgObject.sport = imgUrl

            }else if(temp == "work"){
            //工作照片
                imgObject.work = imgUrl

            }else if(temp == "swimwear"){
            //泳衣照片
                imgObject.swimwear = imgUrl

            }else if(temp == "avatar"){
            //头像照片
                imgObject.avatar = imgUrl
