...
$("#insert").on("click",".reject",function(){
	...
	// console.log(typeof $('.'+fuc+'').attr(fuc+"data-prive"))
...
function addList(data){
	...
	var list = 	data.length	
	    ...
	    // console.log(pubArr)
		    ...
		    str += '<tr><th colspan="2"><span class="listNumber pull-left">'+(i+1)+'</span><span class="checking">审核中</span><span class="listbutton pass pull-right" data-id='+data[i]._id+'>审核通过</span><span '+data[i]._id+'data-prive='+priArr+' '+data[i]._id+'data-public='+pubArr+' failid='+data[i]._id+' class="'+data[i]._id+' listbutton faile pull-right reject">拒绝</span></th></tr>'
...
function addOneList(data){
	...
	var str = ''
		str += '<div classs="content">'
	    str += '<table cellspacing="0">'
		    str += '<tr><th colspan="2"><span class="listNumber pull-left">1</span><span class="checking">审核中</span><span class="listbutton pass pull-right" data-id='+data._id+'>审核通过</span><span '+data._id+'data-prive='+priArr+' '+data._id+'data-public='+pubArr+' failid='+data._id+' class="'+data._id+' listbutton faile pull-right reject">拒绝</span></th></tr>'
